...
class MiniDnDGame
{
    ...
    static void Main(string[] args) {
        ...
        int criticalFailureBonus = 10; // Extra penalty on critical failures / NAT 1 (common house rule in the game dnd)
        ...
        string[,] sceneNarration = {
           ...
           "\nA suffocating darkness begins to seep from the corners, whispering threats." +
           "\n\t\"Leave... or be claimed.\"" +
        ...
        for (int scene = 0; scene < 3; scene++) {
            ...
            int fateChance = diceRoll.Next(1, 101);
            roll = diceRoll.Next(1, 21); //Roll the dice
            Console.WriteLine("\nYou rolled the dice and got " + roll + " as a result.");

            int penalty = penalties[scene, choice - 1];

            //Display outcome with 45% chance of curse affecting even high rolls
            if (roll == 1) { 
            ...
            }else if (roll >= threshold && fateChance <= 55){
                Console.WriteLine("Success! " + successOutcomes[scene, choice - 1]);
                ...
                Console.WriteLine($"The toll of your misstep is harsh… you lose {penalty} HP. \nRemaining HP: {playerHealth}");
             }
             Pause();
            ...
            Console.WriteLine("\nThe dungeon master nods solemnly: Thank you for undertaking on this adventure!");
        }
}